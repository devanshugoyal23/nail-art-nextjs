      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <nav className="mb-6">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-white font-medium">Techniques</span>
          </div>
        </nav>
              ...
              <div className="relative h-48">
                ...
                <div className="absolute top-4 right-4">
                  <span className={`px-2 py-1 rounded text-xs font-semibold ${
                    technique.difficulty === 'Easy' ? 'bg-green-600 text-white' :
                    technique.difficulty === 'Medium' ? 'bg-yellow-600 text-white' :
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">{technique.time}</p>
                  </div>
                  <div>
                    <h3 className="text-sm font-semibold text-green-400 mb-1">Best For:</h3>
                    <p className="text-gray-300 text-sm">{technique.bestFor[0]}</p>
                  </div>
                </div>
              </div>
            </Link>
        ...
        <div className="bg-gray-800 rounded-xl p-8 mb-16">
          <h2 className="text-2xl font-bold text-white mb-6 text-center">Difficulty Guide</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-green-600/20 border border-green-600 rounded-lg p-6">
              ...
              <p className="text-gray-300 mb-4">Perfect for beginners. Simple techniques that are easy to master.</p>
            ...
            <div className="bg-yellow-600/20 border border-yellow-600 rounded-lg p-6">
              ...
              <p className="text-gray-300 mb-4">Some practice required. Great for intermediate nail artists.</p>
              <ul className="text-sm text-gray-300 space-y-1">
                <li>• Ombre Nails</li>
            ...
            <div className="bg-red-600/20 border border-red-600 rounded-lg p-6">
              ...
              <p className="text-gray-300 mb-4">Requires skill and practice. For experienced nail artists.</p>
              <ul className="text-sm text-gray-300 space-y-1">
                <li>• Marble Nails</li>
