      ...
      <div className="min-h-screen bg-[#f8f6f7]">
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="text-center py-8">
            ...
            <h1 className="text-4xl font-bold text-[#1b0d14] mb-4">{displayName} Nail Art</h1>
          ...
          {relatedTechniques.length > 0 && (
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-center">Related Techniques</h2>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <nav className="mb-6">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-[#1b0d14]/50">/</span>
            <span className="text-[#1b0d14] font-medium">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-[#1b0d14]/70 max-w-3xl mx-auto mb-6">
          ...
          <div className="flex justify-center gap-8 mb-6">
            {techniqueData && (
              <>
                <div className="text-center">
                  <div className="text-2xl font-bold text-[#1b0d14]">{techniqueData.difficulty}</div>
                  <div className="text-sm text-[#1b0d14]/60">Difficulty</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-[#1b0d14]">{techniqueData.time}</div>
                  <div className="text-sm text-[#1b0d14]/60">Time Required</div>
                </div>
              </>
            )}
            <div className="text-center">
              <div className="text-2xl font-bold text-[#1b0d14]">{filteredItems.length}</div>
              <div className="text-sm text-[#1b0d14]/60">Designs Available</div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-12">
          ...
          {filteredItems.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-[#1b0d14]/60 mb-6">We&apos;re working on adding more {techniqueData.name.toLowerCase()} designs!</p>
              <Link
                href="/nail-art-gallery"
                className="inline-flex items-center bg-[#ee2b8c] hover:brightness-95 text-white font-semibold py-3 px-6 rounded-full transition-colors"
              >
        ...
        <div className="bg-white rounded-xl p-8 ring-1 ring-[#ee2b8c]/15">
          <h2 className="text-2xl font-bold mb-6 text-center">Explore Other Techniques</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {Object.entries(techniqueInfo).filter(([key]) => key !== technique).map(([key, data]) => (
              ...
              >
                ...
                <div className="text-[#1b0d14]/70 text-xs mt-1">{data.difficulty}</div>
              </Link>
            ))}
          </div>
        </div>
