        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="bg-purple-900/30 rounded-xl p-8 border border-purple-700 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/contact"
                className="bg-primary text-gray-900 font-bold py-3 px-6 rounded-lg hover:bg-primary-dark transition-colors"
              >
                Contact Us
              </Link>
              <Link
                href="/try-on"
                className="bg-gray-600 text-gray-900 font-bold py-3 px-6 rounded-lg hover:bg-gray-100 transition-colors"
              >
                Try Virtual Try-On
              </Link>
            </div>
