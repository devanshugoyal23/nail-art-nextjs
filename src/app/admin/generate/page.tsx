      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-500 mt-2">Advanced content generation with tag management and impact analysis</p>
          </div>
          <Link
            href="/admin/content-management"
            className="bg-blue-600 hover:bg-blue-700 text-gray-900 px-4 py-2 rounded-lg transition-colors"
          >
            Content Management
          </Link>
        </div>
              ...
              <div className="flex gap-2">
                ...
                {isGeneratingTagPages && (
                  <button
                    ...
                    className="bg-red-600 hover:bg-red-700 text-gray-900 px-3 py-1 rounded text-sm"
                  >
                    Cancel
                  </button>
                )}
            ...
            <div className="bg-surface rounded-lg p-6">
              ...
              <div className="flex gap-4 mt-6">
                ...
                <div className="mt-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    <button
                      ...
                      className="bg-red-600 hover:bg-red-700 text-gray-900 px-4 py-2 rounded-lg transition-colors text-sm"
                    >
                      🔴 Red Nails
                    </button>
                    <button
                      ...
                      className="bg-primary hover:bg-primary-dark text-gray-900 px-4 py-2 rounded-lg transition-colors text-sm"
                    >
                      💅 French Tips
                    </button>
                    <button
                    ...
                    <button
                      ...
                      className="bg-green-600 hover:bg-green-700 text-gray-900 px-4 py-2 rounded-lg transition-colors text-sm"
                    >
                      🎄 Christmas
                    </button>
                  </div>
                ...
                <button
                  ...
                  className="bg-blue-600 hover:bg-blue-700 disabled:bg-gray-600 text-gray-900 font-bold py-3 px-6 rounded-lg transition-colors"
                >
                  Analyze Impact
                </button>
              </div>
                  ...
                  {categoryImpact.map((impact, index) => (
                    <div key={index} className="bg-gray-100 rounded-lg p-4">
                      ...
                      {impact.newTags.length > 0 && (
                        <div className="mt-2">
                          <p className="text-sm text-gray-500">New tags: {impact.newTags.join(', ')}</p>
                        </div>
                      )}
                    </div>
                  ))}
            ...
            {results.length > 0 && (
              <div className="bg-surface rounded-lg p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {results.map((result) => (
                    <div key={result.id} className="bg-gray-100 rounded-lg overflow-hidden">
                      <OptimizedImage
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex gap-2">
                    <button
                      ...
                      className="bg-primary hover:bg-primary-dark disabled:bg-gray-600 text-gray-900 font-bold py-3 px-6 rounded-lg transition-colors flex-1"
                    >
                    ...
                    {isGeneratingTagPages && (
                      <button
                        onClick={cancelTagPagesGeneration}
                        className="bg-red-600 hover:bg-red-700 text-gray-900 font-bold py-3 px-4 rounded-lg transition-colors"
                      >
                        Cancel
                      </button>
                    )}
            ...
            <div className="bg-surface rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-gray-100 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-gray-500">Items to generate (3 per tag)</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-surface rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <button
                  ...
                  className="bg-red-600 hover:bg-red-700 disabled:bg-gray-600 text-gray-900 px-4 py-3 rounded-lg transition-colors"
                >
                ...
                <button
                  ...
                  className="bg-yellow-600 hover:bg-yellow-700 disabled:bg-gray-600 text-gray-900 px-4 py-3 rounded-lg transition-colors"
                >
                ...
                <button
                  ...
                  className="bg-blue-600 hover:bg-blue-700 disabled:bg-gray-600 text-gray-900 px-4 py-3 rounded-lg transition-colors"
                >
          ...
          <div className="space-y-8">
            <div className="bg-surface rounded-lg p-6">
              ...
              <button
                onClick={analyzeCategoryImpact}
                disabled={isGeneratingNailArt || isGeneratingForTag || isGeneratingTagPages || (!selectedCategory && !customPrompt)}
                className="mt-6 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-600 text-gray-900 font-bold py-3 px-6 rounded-lg transition-colors"
              >
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-100 p-4 rounded-lg">
                  ...
                  <div className="space-y-3">
                    <div>
                      <h4 className="font-medium text-gray-900">1. Simple Generation</h4>
                      <p className="text-gray-500 text-sm">Enter a category name and number of items to generate basic nail art content.</p>
                      <div className="bg-gray-600 p-2 rounded mt-2 text-sm">
                        <strong>Example:</strong> Category: &quot;Red Nails&quot;, Count: 5
                      </div>
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-900">2. Custom Prompts</h4>
                      <p className="text-gray-500 text-sm">Use custom prompts for specific design requirements.</p>
                      <div className="bg-gray-600 p-2 rounded mt-2 text-sm">
                        <strong>Example:</strong> &quot;vintage red nails with gold accents for wedding&quot;
                      </div>
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-900">3. Tiered Generation</h4>
                      <p className="text-gray-500 text-sm">Generate content in multiple tiers for comprehensive coverage.</p>
                      <div className="bg-gray-600 p-2 rounded mt-2 text-sm">
                ...
                <div className="bg-gray-100 p-4 rounded-lg">
                  ...
                  <div className="space-y-3">
                    <div>
                      <h4 className="font-medium text-gray-900">1. View Under-Populated Tags</h4>
                      <p className="text-gray-500 text-sm">See all tags that need more content (less than 5 items).</p>
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-900">2. Generate for Specific Tags</h4>
                      <p className="text-gray-500 text-sm">Select a tag and generate content specifically for it.</p>
                      <div className="bg-gray-600 p-2 rounded mt-2 text-sm">
                        <strong>Example:</strong> Select &quot;Hand Painting&quot; → Generate 3 items → Creates hand painting designs
                      </div>
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-900">3. Fix Empty Tag Pages</h4>
                      <p className="text-gray-500 text-sm">One-click solution to populate all empty tag pages (200+ critical tags).</p>
                      <div className="bg-gray-600 p-2 rounded mt-2 text-sm">
                ...
                <div className="bg-gray-100 p-4 rounded-lg">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="text-gray-500 text-sm">Analyze how new content will affect existing categories.</p>
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-900">2. SEO Thresholds</h4>
                      <p className="text-gray-500 text-sm">See which categories will reach SEO-friendly thresholds (3+ items).</p>
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-900">3. Tag Detection</h4>
                      <p className="text-gray-500 text-sm">Automatically detect new tags from custom prompts.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-100 p-4 rounded-lg">
                  ...
                  <div className="space-y-3">
                    <div>
                      <h4 className="font-medium text-gray-900">1. Start with Tag Analysis</h4>
                      <p className="text-gray-500 text-sm">Check under-populated tags first to identify content gaps.</p>
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-900">2. Use Impact Analysis</h4>
                      <p className="text-gray-500 text-sm">Analyze impact before generating to ensure strategic content creation.</p>
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-900">3. Fix Empty Pages</h4>
                      <p className="text-gray-500 text-sm">Use &quot;Fix Empty Tag Pages&quot; to ensure all important tag pages have content.</p>
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-900">4. Monitor Results</h4>
                      <p className="text-gray-500 text-sm">Check the Content Management page to see overall content distribution.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-100 p-4 rounded-lg">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-gray-600 p-3 rounded">
                      <h4 className="font-medium text-gray-900">For New Sites</h4>
                      <p className="text-gray-500 text-sm">1. Fix Empty Tag Pages<br/>2. Generate for high-priority tags<br/>3. Use Impact Analysis</p>
                    </div>
                    <div className="bg-gray-600 p-3 rounded">
                      <h4 className="font-medium text-gray-900">For Existing Sites</h4>
                      <p className="text-gray-500 text-sm">1. Check under-populated tags<br/>2. Generate for specific gaps<br/>3. Monitor content distribution</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-100 p-4 rounded-lg">
                  ...
                  <div className="space-y-3">
                    <div>
                      <h4 className="font-medium text-gray-900">Empty Tag Pages</h4>
                      <p className="text-gray-500 text-sm">Use &quot;Fix Empty Tag Pages&quot; button to populate all critical tag pages automatically.</p>
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-900">Low Content Categories</h4>
                      <p className="text-gray-500 text-sm">Check under-populated tags and generate content for specific categories.</p>
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-900">SEO Issues</h4>
                      <p className="text-gray-500 text-sm">Use Impact Analysis to ensure categories reach minimum thresholds (3+ items).</p>
                    </div>
                  </div>
                </div>
              </div>
