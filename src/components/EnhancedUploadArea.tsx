        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button
              ...
              className="px-6 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 disabled:bg-gray-500 disabled:cursor-not-allowed transition-colors font-semibold"
            >
              Choose File
            </button>
            <button
