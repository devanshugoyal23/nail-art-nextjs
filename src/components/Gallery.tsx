  ...
  if (items.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-400">Generate some nail art to see them here!</p>
      </div>
    )
  }
          ...
          >
            ...
            <div className="p-4">
              ...
              <Link 
                ...
                className="w-full bg-purple-600 text-white font-bold py-2 px-4 rounded-lg hover:bg-purple-700 transition duration-300 text-center block"
              >
                Try This Design
              </Link>
            </div>
